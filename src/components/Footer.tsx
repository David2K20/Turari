const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/turari',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center">
            <a 
              ...
              className="font-inter text-sm text-secondary hover:text-primary transition-colors duration-300"
            >
